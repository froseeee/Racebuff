...
class TrackNotesEditor(BaseEditor):
    ...
    def toggle_trackmap_panel(self):
        ...
        if self.trackmap_panel.isHidden():
            ...
            self.button_showmap.setText(tr("Hide Map"))
        else:
            self.trackmap_panel.hide()
            self.button_showmap.setText(tr("Show Map"))
    ...
    def save_notes(self, notes_type: str):
        ...
        QMessageBox.information(self, tr("Saved"), tr("Notes saved at:<br><b>{filename}</b>", filename=filename_full))
