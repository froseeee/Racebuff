...
class FuelCalculator(BaseDialog):
    ...
    def toggle_history_panel(self):
        ...
        if self.panel_table.isHidden():
            ...
            self.setFixedWidth(self.sizeHint().width())
            self.button_toggle.setText(tr("Hide History"))
        else:
            ...
            self.button_toggle.setText(tr("Show History"))
    ...
    def set_panel_table(self, panel):
        ...
        button_adddata = QPushButton(tr("Add Selected Data"))
...
class InputLapTime():
    ...
    def __init__(self, parent, frame) -> None:
        ...
        layout.addWidget(QLabel(tr("Lap Time:")), 0, 0, 1, 6)
...
class InputFuel():
    ...
    def __init__(self, parent, frame) -> None:
        ...
        layout.addWidget(QLabel(tr("Tank Capacity:")), 0, 0, 1, 2)
        layout.addWidget(self.capacity, 1, 0)
        layout.addWidget(QLabel(parent.symbol_fuel), 1, 1)

        layout.addWidget(QLabel(tr("Fuel Ratio:")), 2, 0, 1, 2)
        layout.addWidget(self.fuel_ratio, 3, 0)

        layout.addWidget(QLabel(tr("Fuel Consumption:")), 0, 2, 1, 2)
        layout.addWidget(self.fuel_used, 1, 2)
        layout.addWidget(QLabel(parent.symbol_fuel), 1, 3)

        layout.addWidget(QLabel(tr("Energy Consumption:")), 2, 2, 1, 2)
...
class InputRace():
    ...
    def __init__(self, parent, frame) -> None:
        ...
        layout.addWidget(QLabel(tr("Race Minutes:")), 0, 0, 1, 2)
        layout.addWidget(self.minutes, 1, 0)
        layout.addWidget(QLabel("min"), 1, 1)

        layout.addWidget(QLabel(tr("Race Laps:")), 0, 2, 1, 2)
        layout.addWidget(self.laps, 1, 2)
        layout.addWidget(QLabel("lap"), 1, 3)

        layout.addWidget(QLabel(tr("Formation/Rolling:")), 2, 0, 1, 2)
        layout.addWidget(self.formation, 3, 0)
        layout.addWidget(QLabel("lap"), 3, 1)

        layout.addWidget(QLabel(tr("Average Pit Seconds:")), 2, 2, 1, 2)
...
class OutputUsage():
    ...
    def __init__(self, parent, frame, type_name) -> None:
        ...
        layout.addWidget(QLabel(tr("One Less Pit Stop:")), 14, 0, 1, 2)
...
class InputRefill():
    ...
    def __init__(self, parent, frame, type_name) -> None:
        ...
        layout.addWidget(QLabel(tr("Average Refilling:")), 2, 0, 1, 2)
...
class InputTyreWear():
    ...
    def __init__(self, parent, frame) -> None:
        ...
        layout.addWidget(QLabel(tr("Starting Tyre Tread:")), 0, 0, 1, 2)
        layout.addWidget(self.start_tread, 1, 0)
        layout.addWidget(QLabel("%"), 1, 1)

        layout.addWidget(QLabel(tr("Lifespan Laps:")), 0, 2, 1, 2)
        layout.addWidget(self.lifespan_laps, 1, 2)
        layout.addWidget(QLabel("lap"), 1, 3)

        layout.addWidget(QLabel(tr("Tread Wear Per Lap:")), 2, 0, 1, 2)
        layout.addWidget(self.wear_lap, 3, 0)
        layout.addWidget(QLabel("%"), 3, 1)

        layout.addWidget(QLabel(tr("Lifespan Minutes:")), 2, 2, 1, 2)
        layout.addWidget(self.lifespan_minutes, 3, 2)
        layout.addWidget(QLabel("min"), 3, 3)

        layout.addWidget(QLabel(tr("Tread Wear Per Stint:")), 4, 0, 1, 2)
        layout.addWidget(self.wear_stint, 5, 0)
        layout.addWidget(QLabel("%"), 5, 1)

        layout.addWidget(QLabel(tr("Lifespan Stints:")), 4, 2, 1, 2)
