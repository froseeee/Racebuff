...
DESTINATION_PATH="${SHARE_PATH}/RaceBuff"
...
rm -f "${APPLICATIONS_PATH}/TinyPedal-overlay.desktop" "${APPLICATIONS_PATH}/RaceBuff-overlay.desktop" "${BIN_PATH}/TinyPedal" "${BIN_PATH}/RaceBuff"

echo "Writing ${APPLICATIONS_PATH}/RaceBuff-overlay.desktop"
replace "/usr/local" "${DESTINATION_PREFIX}" <"${SOURCE_PATH}/RaceBuff-overlay.desktop" >"${APPLICATIONS_PATH}/RaceBuff-overlay.desktop"

echo "Writing ${BIN_PATH}/RaceBuff"
replace "./" "${DESTINATION_PATH}/" <"${SOURCE_PATH}/RaceBuff.sh" >"${BIN_PATH}/RaceBuff"
chmod a+x "${BIN_PATH}/RaceBuff"
