...
**RaceBuff** is a fork of [TinyPedal](https://github.com/TinyPedal/TinyPedal). All credits for the original project and its contributors belong to the TinyPedal team.

## Original TinyPedal — development and contributors
...
* Fork maintainer: see repository owner.
* This fork adds iRacing support, Russian language, and rebranding; core functionality and design are from TinyPedal.
